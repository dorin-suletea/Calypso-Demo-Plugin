...
public class EntityModelMoveDownDataCommand implements CommandInterface {
	private DataModelInterface dataLine;
	private EntityViewProxy viewHost;

	private int index;

	public EntityModelMoveDownDataCommand(EntityViewProxy viewHost, DataModelInterface dataLine, int index) {
		super();
	...
	public boolean isValid() {
		if (index > dataLine.getDataLine().size() - 2 || index<0)
			return false;
		return true;
	}
